...
begin
    using PalmerPenguins, DataFrames, AlgebraOfGraphics, CairoMakie, ColorSchemes, Colors
...
# ╔═╡ 965d3f4b-3d26-4c58-8d09-04e17c1872b8
data(penguins) * mapping(:bill_length_mm => (t -> t + 10) => "bill length (cm)")
...
git-tree-sha1 = "063635b0cd26fc2227aed2649a2665ab5846feb8"
